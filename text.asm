...
_TradeCenterMTextInverseOn::
	text "You have turned"
	line "INVERSE MODE on."
	cont "Be sure your"
	cont "opponent has it"
	cont "switched on, too."
	done

_TradeCenterMTextInverseOff::
	text "You have turned"
	line "INVERSE MODE off."
	cont "Be sure your"
	cont "opponent has it"
	cont "switched off, too."
	done
