...
; written to but nothing ever reads it [use as extra]
	ds 1
...
SECTION "Stackc", WRAMX[$d31d], BANK[1]
...
SECTION "Idontthinksotim", WRAMX[$D5A0], BANK[1]
...
SECTION "Hack", WRAMX[$DA71], BANK[1]

W_BATTLEFACTORYCURSCRIPT::
	ds 1
W_CURSTREAK::
	ds 1
W_BESTSTREAK::
...
W_DAYCAREMONNAME:: ; no longer in use
W_DAYCAREMONOT:: ; no longer in use
wDayCareMon:: ; da5f - merged with the others, day care is glitched
wDayCareMonSpecies::    
wDayCareMonHP::         
wDayCareMonBoxLevel::  
wDayCareMonStatus::     
...
SECTION "asdf", WRAMX[$DA80], BANK[1]
