...
_SaffronCityText21:: ; a6667 (29:6667)
	...
	para "New prototype"
	line "BALLS, brought"
	cont "to you by SILPH"
	cont "CO.!"

	para "Try LUXURY BALL"
	line "and SHINY BALL!"

	para "LUXURY BALL br-"
	line "ings out the max"
	cont "potential of a"
	cont "#MON."

	para "SHINY BALL will"
	line "induce a change"
	cont "of color for the"
	cont "captured #MON!"
	done
